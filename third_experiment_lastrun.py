...
expName = 'third_experiment'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\91991\\Desktop\\PSY310\\Experiments\\third_experiment_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    # --------Prepare to start Staircase "star" --------
    # set up handler to look after next chosen value etc
    star = data.StairHandler(startVal=10.0, extraInfo=expInfo,
        stepSizes=[2,1,1,0.5], stepType='lin',
        nReversals=0.0, nTrials=100.0, 
        nUp=1.0, nDown=3.0,
        minVal=1.0, maxVal=20.0,
        originPath=-1, name='star')
    thisExp.addLoop(star)  # add the loop to the experiment
    level = thisStar = 10.0  # initialise some vals
    
    for thisStar in star:
        currentLoop = star
        ...
        # store data for star (StairHandler)
        star.addResponse(key_resp.corr, level)
        star.addOtherData('key_resp.rt', key_resp.rt)
