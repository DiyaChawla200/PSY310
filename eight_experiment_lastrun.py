...
expName = 'eight_experiment'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\91991\\Desktop\\PSY310\\Experiments\\eight_experiment_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    trials = data.TrialHandler(nReps=10.0, method='random', 
        ...
        trialList=data.importConditions('conditions_eightexp.xlsx'),
