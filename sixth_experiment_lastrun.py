...
expName = 'sixth_experiment'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\91991\\Desktop\\PSY310\\Experiments\\sixth_experiment_lastrun.py',
